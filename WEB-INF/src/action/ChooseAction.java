...
public class ChooseAction {
	...
	{
		String gbusname="";
		String gdeparaturedate="";
		String gleavingfrom="";
		String ggoingto="";
		String gdeparaturetime="";	
		String gs1;
		String gs2;
		String gs3;
		String gs4;
		...
		//carry busname
		gbusname=db.displaybusname(travel);
		session.setAttribute("busname", gbusname);
		//carry deparature date
		gdeparaturedate=db.displaydeparatuerdate(travel);
		session.setAttribute("deparaturedate", gdeparaturedate);
						
		//carry leaving from
		gleavingfrom=db.displayleavingfrom(travel);
		session.setAttribute("leavingfrom", gleavingfrom);
								
		//carry going to
		ggoingto=db.displaygoingto(travel);
		session.setAttribute("goingto", ggoingto);
						
		//carry deparature time
		gdeparaturetime=db.displaydeparatuertime(travel);
		session.setAttribute("deparaturetime", gdeparaturetime);
