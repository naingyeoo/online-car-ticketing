    ...
    <link rel="icon" type="image/x-icon" href="/BookingSystem/imagePhoto/abcd.png" />
  	<div class="content-wrapper">
  		<section class="content-header">
  			<h1>Select the Bus Line Infomation to Update (<font color="green">Available</font> => <font color="red">Sold Out</font>)</h1>
    	</section>
		<!-- Main content -->
...
<s:form action="searchAvailableSeatInfo" theme="simple">
...
<td><font color="red"><s:fielderror fieldName="travel.busname"></s:fielderror></font></td>
</tr>
...
<tr><td><br><td><td><br><td></tr>
<tr><td></td><td><s:submit value="Search Available Seat" style="width:200px; background-color:green; color:white;"></s:submit></td></tr>
</table>
</s:form>
